        ...
        <div className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr_1.2fr] lg:gap-8">
          <section className="border-b border-brand-200 pb-4 lg:border-b-0 lg:border-r lg:pb-0 lg:pr-7">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              <Link
                href="/request-quote"
                className="inline-flex items-center rounded-md bg-brand-500 px-3 py-2 text-sm font-semibold text-white transition hover:bg-brand-600"
              >
                Contact Us
              </Link>
              ...
              {[
                {
                  label: "LinkedIn",
                  link: "https://in.linkedin.com/company/credence-automation-and-control-systems-private-limited",
                  icon: (
